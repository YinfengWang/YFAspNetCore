...
using YF.Core.Datas.Sql.Configs;
using YF.Core.Datas.Sql.Matedatas;
using YF.Core.Extensions;
using YF.Data.Dapper.Handlers;
using YF.Data.Dapper.MySql;
using YF.Data.Dapper.Oracle;
using YF.Data.Dapper.PgSql;
using YF.Data.Dapper.SqlServer;

namespace YF.Data.Dapper {
    /// <summary>
    /// 服务扩展
    /// </summary>
