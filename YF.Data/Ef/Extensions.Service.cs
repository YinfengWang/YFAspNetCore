...
using YF.Core.Datas.Enums;
using YF.Core.Datas.UnitOfWorks;
using YF.Data.Dapper;
using YF.Data.Ef.Configs;
...
namespace YF.Data.Ef
{
    ...
    public static partial class Extensions
    {
        ...
        private static DatabaseType GetDbType<TUnitOfWork>()
        {
            ...
            if (type == typeof(YF.Data.Ef.SqlServer.UnitOfWork))
                return DatabaseType.SqlServer;
            if (type == typeof(YF.Data.Ef.MySql.UnitOfWork))
                return DatabaseType.MySql;
            if (type == typeof(YF.Data.Ef.PgSql.UnitOfWork))
                return DatabaseType.PgSql;
            if (type == typeof(YF.Data.Ef.Oracle.UnitOfWork))
