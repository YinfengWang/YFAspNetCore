...
using YF.Data.Ef.Logs;
using YF.Core.Logs;
using YF.Data.Ef.Configs;
using YF.Core.Domains.Auditing;
using YF.Core.Exceptions;
using YF.Core.Datas.Transactions;
using YF.Core.Extensions;
using YF.Core.Sessions;
using YF.Core.Security;
using YF.Logs;

namespace YF.Data.Ef.Core {
    /// <summary>
    /// 工作单元
    /// </summary>
    public abstract class UnitOfWorkBase : DbContext, IUnitOfWork, IDatabase, IEntityMatedata {
        ...
        protected UnitOfWorkBase( DbContextOptions options, IServiceProvider serviceProvider )
            ...
            Session = YF.Core.Sessions.Session.Instance;
