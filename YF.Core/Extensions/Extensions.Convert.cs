...
namespace YF.Core.Extensions
{
    ...
    public static partial class Extensions {
        ...
        public static bool ToBool( this string obj ) {
            return YF.Core.Helpers.Convert.ToBool( obj );
        }
        ...
        public static bool? ToBoolOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToBoolOrNull( obj );
        }
        ...
        public static int ToInt( this string obj ) {
            return YF.Core.Helpers.Convert.ToInt( obj );
        }
        ...
        public static int? ToIntOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToIntOrNull( obj );
        }
        ...
        public static long ToLong( this string obj ) {
            return YF.Core.Helpers.Convert.ToLong( obj );
        }
        ...
        public static long? ToLongOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToLongOrNull( obj );
        }
        ...
        public static double ToDouble( this string obj ) {
            return YF.Core.Helpers.Convert.ToDouble( obj );
        }
        ...
        public static double? ToDoubleOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToDoubleOrNull( obj );
        }
        ...
        public static decimal ToDecimal( this string obj ) {
            return YF.Core.Helpers.Convert.ToDecimal( obj );
        }
        ...
        public static decimal? ToDecimalOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToDecimalOrNull( obj );
        }
        ...
        public static DateTime ToDate( this string obj ) {
            return YF.Core.Helpers.Convert.ToDate( obj );
        }
        ...
        public static DateTime? ToDateOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToDateOrNull( obj );
        }
        ...
        public static Guid ToGuid( this string obj ) {
            return YF.Core.Helpers.Convert.ToGuid( obj );
        }
        ...
        public static Guid? ToGuidOrNull( this string obj ) {
            return YF.Core.Helpers.Convert.ToGuidOrNull( obj );
        }
        ...
        public static List<Guid> ToGuidList( this string obj ) {
            return YF.Core.Helpers.Convert.ToGuidList( obj );
        }
