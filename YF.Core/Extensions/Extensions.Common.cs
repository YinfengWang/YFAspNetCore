...
namespace YF.Core.Extensions
{
    ...
    public static partial class Extensions {
        ...
        public static int Value( this System.Enum instance ) {
            if( instance == null )
                return 0;
            return YF.Core.Helpers.Enum.GetValue( instance.GetType(), instance );
        }
        ...
        public static TResult Value<TResult>( this System.Enum instance ) {
            ...
            return YF.Core.Helpers.Convert.To<TResult>( Value( instance ) );
        }
        ...
        public static string Description( this System.Enum instance ) {
            if ( instance == null )
                return string.Empty;
            return YF.Core.Helpers.Enum.GetDescription( instance.GetType(), instance );
        }
        ...
        public static string Join<T>( this IEnumerable<T> list, string quotes = "", string separator = "," ) {
            return YF.Core.Helpers.String.Join( list, quotes, separator );
        }
    }
}
