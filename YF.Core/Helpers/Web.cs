...
using YF.Core.Security.Principals;

namespace YF.Core.Helpers {
    /// <summary>
    /// Web操作
    /// </summary>
    public static class Web {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static YF.Core.Webs.Clients.WebClient Client() {
            return new YF.Core.Webs.Clients.WebClient();
        }
        ...
        public static YF.Core.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class {
            return new YF.Core.Webs.Clients.WebClient<TResult>();
        }
