...
namespace YF.Core.Files {
    ...
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return YF.Core.Helpers.Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return YF.Core.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return YF.Core.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
